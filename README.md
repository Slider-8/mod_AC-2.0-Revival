...
**Current version: [v2.1.11](docs/REQUIREMENTS.md)**  
...
2. Build or take a package: `dist/mod_AC_2.1.11.zip` (see [Build](#build)).
...
4. Confirm in `Documents\Battle Brothers\log.html`:  
   `Modern Hooks registered Accessory Companions (mod_AC) version 2.1.11`.
...
| In-game playtest | **2.1.9:** ~3.3 h manual session, clean (2026-07-26). A later 2026-07-28 session hit a hover crash in Tame targeting — fixed in **2.1.11** as [D18](docs/DEFECTS.md). 2.1.11 is not yet playtested. [docs/PLAYTEST.md](docs/PLAYTEST.md) |
...
tools/                             build.py, check_mod.py, setup_refs.sh
