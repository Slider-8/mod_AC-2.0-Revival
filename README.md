...
**Current version: [v2.1.14](docs/REQUIREMENTS.md)**  
...
2. Build or take a package: `dist/mod_AC_2.1.14.zip` (see [Build](#build)).
...
4. Confirm in `Documents\Battle Brothers\log.html`:  
   `Modern Hooks registered Accessory Companions (mod_AC) version 2.1.14`.
